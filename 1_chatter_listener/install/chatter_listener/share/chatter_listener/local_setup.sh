...
: ${AMENT_CURRENT_PREFIX:="/home/atharva/git/MARIO/1_chatter_listener/install/chatter_listener"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/chatter_listener/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/chatter_listener/environment/path.sh"
